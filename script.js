...
;(function () {
	...
	try {
		const _s = localStorage.getItem('plinkoStats')
		if (_s) plinkoStats = JSON.parse(_s)
	} catch (e) {}
	...
	;(function () {
		...
		window._plinkoTick = mkA(
			'',
		)
	...
	// ── Multipliers (center = big loss, edges = rare win) ─────────────────────
	const MULT_TABLES = {
		8: [8, 3, 1.2, 0.4, 0.2, 0.4, 1.2, 3, 8],
		12: [15, 5, 2, 0.8, 0.4, 0.2, 0.1, 0.2, 0.4, 0.8, 2, 5, 15],
		16: [
			50, 12, 5, 2, 0.8, 0.4, 0.2, 0.1, 0.1, 0.1, 0.2, 0.4, 0.8, 2, 5, 12, 50,
		],
	}
	...
	function setupCanvas() {
		...
		const cellW = Math.min(36, Math.floor(460 / (cols + 1)))
	...
	// ── Draw board ────────────────────────────────────────────────────────────
	function drawBoard(setup, highlightIdx) {
		...
		// Buckets
		const bucketH = Math.max(24, cellW * 0.78)
		const bucketsY = H - bucketH - 3
		const slot = W / mults.length
		const gap = Math.max(2, slot * 0.07)
		mults.forEach((m, i) => {
			const bx = i * slot + gap / 2
			const bw = slot - gap
			const hit = highlightIdx === i
			const color = getMultColor(m)
			ctx.globalAlpha = hit ? 1 : 0.9
			...
			ctx.stroke()
			ctx.globalAlpha = 1
			const fs = Math.max(7, Math.min(13, bw * 0.35))
	...
	// ── Animate one ball (setTimeout, not rAF — works even on hidden tabs) ────
	function animateBall(setup, path, color) {
		return new Promise(resolve => {
			...
			function step() {
				...
				// tick sound on each peg
				if (window._plinkoTick)
					try {
						const s = window._plinkoTick.cloneNode()
						s.volume = 0.22
						s.play()
					} catch (e) {}
	...
	function showPlinkoMsg(text, color, bg) {
		const el = document.getElementById('plinkoResult')
		if (!el) return
		clearTimeout(el._t)
		el.innerHTML = text
		el.style.cssText = `display:block;opacity:1;transform:none;margin:12px 0 0;padding:14px 18px;border-radius:12px;font-size:1.1rem;font-weight:700;text-align:center;transition:opacity 0.4s;color:${color};background:${bg};border:2px solid ${color}`
		el._t = setTimeout(() => {
			el.style.opacity = '0'
			setTimeout(() => {
	...
	window.dropPlinkoBalls = async function () {
		...
		if (!window.currentUser) {
			showPlinkoMsg('❌ Войдите в аккаунт!', '#f4212e', 'rgba(244,33,46,0.12)')
			return
		}
	...
	// ── Open / close hooks ────────────────────────────────────────────────────
	const _origOpen = window.openCasinoGame
	window.openCasinoGame = function (gameName) {
		if (gameName === 'plinko') {
			document
				.querySelectorAll('.casino-game')
